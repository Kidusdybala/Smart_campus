...
const notificationSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    enum: ['grade_published', 'grade_rejected', 'assignment_due', 'course_announcement', 'system', 'payment_success', 'payment_failed', 'wallet_topup', 'low_balance', 'payment_pending', 'food_ready', 'order_ready'],
    required: true
  },
